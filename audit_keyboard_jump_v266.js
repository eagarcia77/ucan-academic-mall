...
const checks={
  moduleLoaded:legacyLoader||questR2Loader,
  questR2LoaderValid:!questR2Loader||/ucan_v304_quest_visual_entry_r2\.js\?build=V304-20260724-QUEST-GLASS-SIGNS-VR-R2/.test(main),
...
console.log(JSON.stringify({ok,version:'V266',checks,loader:{legacyLoader,questR2Loader}},null,2));
