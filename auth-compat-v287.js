...
function transformCampusHtml(text) {
  let html = text
    ...
    .replace(
      ...
      'V287: cada piso mantiene un estado explícito y el cielo optimizado de la terraza reduce geometría, texturas y actualizaciones.'
    );
...
if (!http.ServerResponse.prototype.__ucanV287FloorSkyPatched) {
  ...
  http.ServerResponse.prototype.end = function patchedEnd(chunk, encoding, callback) {
    ...
    try {
      ...
      console.error('[UCAN V287 response compatibility]', error);
    }
