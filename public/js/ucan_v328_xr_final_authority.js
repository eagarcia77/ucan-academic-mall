(() => {
  ...
  const ROUTES = Object.freeze({
    up12:  { id:'up12', fromFloor:0,    toFloor:8.2,  centerX:-20, halfWidth:3.45, fromZ:32,   toZ:10,   direction:-1, duration:3600, label:'Subiendo al Piso 2' },
    down21:{ id:'down21',fromFloor:8.2,  toFloor:0,    centerX:-8,  halfWidth:3.45, fromZ:10,   toZ:32,   direction:1,  duration:3600, label:'Bajando al Piso 1' },
    up23:  { id:'up23', fromFloor:8.2,  toFloor:16.4, centerX:-34, halfWidth:3.45, fromZ:32,   toZ:10,   direction:-1, duration:3600, label:'Subiendo al Piso 3' },
    down32:{ id:'down32',fromFloor:16.4, toFloor:8.2,  centerX:-26, halfWidth:3.45, fromZ:10,   toZ:32,   direction:1,  duration:3600, label:'Bajando al Piso 2' },
    up34:  { id:'up34', fromFloor:16.4, toFloor:27.2, centerX:44,  halfWidth:4.55, fromZ:39,   toZ:10.5, direction:-1, duration:5200, label:'Subiendo a la terraza' },
    down34:{ id:'down34',fromFloor:27.2, toFloor:16.4, centerX:44,  halfWidth:4.55, fromZ:10.5, toZ:39,   direction:1,  duration:5200, label:'Bajando al Piso 3' }
  });
  ...
  function entryRoute() {
    ...
    return Object.values(ROUTES).find(route =>
      ...
      Math.abs(world.x-route.centerX) <= route.halfWidth-0.2 &&
  ...
  function install() {
    ...
    publish();
    console.info('[UCAN V328 R32] Autoridad final de altura, escaleras y aterrizaje instalada.');
    return true;
  }
