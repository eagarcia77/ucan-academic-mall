...
const checks = {
  ...
  packageStartsV287Base:startsDirectV287 || startsLayeredV293 || startsLayeredR4,
  ...
  dockerStartsV287Base:dockerDirectV287 || dockerLayeredV293 || dockerLayeredR4,
...
console.log(JSON.stringify({
  ...
  build:BUILD,
  checks,
  preloaderChain:{ startsDirectV287, startsLayeredV293, startsLayeredR4, r4PreservesV293, v293PreservesV287 },
  patchError,
