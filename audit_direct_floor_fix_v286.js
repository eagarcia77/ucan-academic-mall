...
const essential = {
  exactlyOneOriginalCondition:countOriginalTargets(source) === 1,
...
console.log(JSON.stringify({
  ...
  diagnostics,
  syntaxError,
  patchResult:{ patched:result.patched, reason:result.reason, originalOccurrences:result.originalOccurrences }
}, null, 2));
